...
while I hope 'we' (culture all the way from 1980's community work) try 
...
Pure text games were born in a time when computers didnt have most
...
Games from 80's open the vault of interactivity, but could not compete
with even 8 bit era graphics, because:
...
4) awards:
	...
	a place to get a hint about what can you do.
...
7) modern RPG:
	...
	we will give limited space in inventory (to force the player to be
	very picky), and extensive use of fixed attibutes (ST,DX) and dinamic
	attributes (LIFE, MANA). Also, the player will use the world persistency
	to drop and take itens from the ground as needed -- this can be used 
	to 'mark territory' as well.

	we will give your character traits (positive and negative) to add a
	fluid chain of reaction unique for the type of play.

	lots of startups builds for the player experience the game differently
	every play.
...
--------------------------------------------------------
 About this game portal
--------------------------------------------------------

There will be MUCH LESS brutality on the interface and WAY less 
"player hostility" everywhere. 

Lets try to bring people in, not scare them out. ;)
